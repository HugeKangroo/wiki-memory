...
class ObsidianProjectionTest(unittest.TestCase):
    def test_rebuild_writes_human_readable_home_and_alias_pages(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertIn('<div class="wm-api-hero">', api_home)
            self.assertIn('<div class="wm-api-grid">', api_home)
            self.assertIn('<section class="wm-api-card">', api_home)
            ...
            self.assertIn('<div class="wm-api-module">', api_module)
            self.assertIn('<span class="wm-api-badge">Application</span>', api_module)
            self.assertIn('<div class="wm-api-signature">', api_module)
            self.assertIn("**Defined in:** `src/api.py`", api_module)
            self.assertIn("[[API/Classes/MemoryApi|MemoryApi]]", api_module)
            self.assertIn('<table class="wm-api-params">', api_module)
            self.assertIn("<summary><code>ingest_repo</code></summary>", api_module)
            self.assertIn("# Class `MemoryApi`", api_class)
            self.assertIn('<div class="wm-api-class">', api_class)
            self.assertIn('<article class="wm-api-method">', api_class)
